...
async def main():
    ...
    page2 = await browser.get('https://www.absher.sa/wps/vanityurl/en/resetpasswordindividuals', new_tab=True) ### how to open a new tab
    ...
    await userid.send_keys(user_id)
